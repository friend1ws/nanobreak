...
if __name__ == "__main__":
    ...
    count_read_by_alignment(output_prefix + ".tmp.nbp_parse.bp_info_consensus.txt", 
        tumor_bam, 
        output_prefix + ".tmp.tumor.bp_cluster.alignment_count.txt",
        reference_file)

    count_read_by_alignment(output_prefix + ".tmp.nbp_parse.bp_info_consensus.txt", 
        normal_bam, 
        output_prefix + ".tmp.normal.bp_cluster.alignment_count.txt",
        reference_file) 

    join_count_result(output_prefix + ".tmp.nbp_parse.bp_info_consensus.txt",
                      output_prefix + ".tmp.tumor.bp_cluster.alignment_count.txt",
                      output_prefix + ".tmp.normal.bp_cluster.alignment_count.txt",
                      output_prefix + ".nanobreak.result.txt")
